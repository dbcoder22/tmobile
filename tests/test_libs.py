...
__test_dummy_data__ = [
    'T-Mobile', '', '', 'Bill period', 'Mar 19, 2020 - Apr 18, 2020', '', 'Account', '000123', '',
    'Page', '1\xa0of\xa06', '', 'TOTAL DUE', 'DETAILED', '$317.53', 
    'Your bill is due by May 11, 2020.', '',
    'AutoPay is scheduled for May 09, 2020 using Visa', '****1234.', '',
    'Thanks for paying your last bill of $314.62.', '',
    'Hi Mark,', "Here's your bill for April.", 
    ...
    'PLANS', '', '$259.63', '\xa09\xa0VOICE\xa0LINES\xa0=\xa0$259.63\xa0', '', 
    "This month's charges are $0.12 less", '', '• Thanks for being a part of the T-Mobile family!', 
    '', 'COMPARE YOUR PLAN MONTH-TO-MONTH', '', '$259.75', '', 'Jan', '', '  $259.75', '', 
    'Feb', '', '  $259.75', '', 'Mar', '', '  $259.63', '', 'Apr', '', ' ', '', 'EQUIPMENT', '', 
    '$22.34', '\xa02\xa0HANDSETS\xa0=\xa0$22.34\xa0', '',
    "This month's charges are the same as last month's", '', 'SUMMARY'
]

__test_dummy_data_len__ = len(__test_dummy_data__)

__test_actual_data__ = [
    'Previous balance $314.62', '', 'Payment - thank you Mar 28 -$60.00', '', 
    'Payment - thank you Apr 09 -$254.62', '', 'THIS BILL SUMMARY',
    'Line Type Plans Equipment Services Total', '', 'Totals $259.63 $22.34 $35.56 $317.53', 
    '', 'Account $120.57 - - $120.57', '', '(123)\xa0456-7890 Voice $4.29 - - $4.29', '', 
    '(123)\xa0456-7980 Voice $4.29 - $16.37 $20.66', '', '(123)\xa0456-8970 Voice $4.29 - - $4.29', 
    '', 'DETAILED CHARGES', '', 'PLANS $259.63', '', 'REGULAR CHARGES Apr 19 - May 18 $220.00', ''
]
...
def test_create_email_message():
    ...
    """
    msg = create_message("abc@gmail.com", "bcd@gmail.com",
                         "Test email", "This is text of a test email")
